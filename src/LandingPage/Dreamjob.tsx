...
return(
    <div className="flex items-center px-16">
        <div className="flex flex-col w-[45%] gap-3">
            ...
            />
            <div className="flex items-center justify-center h-full w-20 bg-bright-sun-300 text-mine-shaft-900 rounded-lg p-2 hover:bg-bright-sun-500 cursor-pointer">
